              ...
              <Tabs defaultValue="active">
                ...
                <TabsContent value="past" className="mt-4">
                  <div className="p-8 text-center text-gray-500">
                    ...
                    <p>
                      Tugas yang telah melewati tenggat waktu akan muncul di
                      sini.
                    </p>
                  </div>
                </TabsContent>
                <TabsContent value="draft" className="mt-4">
                  <div className="p-8 text-center text-gray-500">
                    <FileText className="h-12 w-12 mx-auto mb-4 text-gray-400" />
                    <h3 className="text-lg font-medium mb-2">
                      Tidak ada draft tugas
                    </h3>
                    <p>
                      Tugas yang disimpan sebagai draft akan muncul di sini.
                    </p>
                  </div>
                </TabsContent>
              </Tabs>
            ...
            <TabsContent value="students" className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Santri yang terdaftar dalam pelajaran Anda
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <TabsContent value="schedule" className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Jadwal mengajar untuk minggu ini
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <span className="hidden md:inline-block">
            Selamat datang, {profile?.full_name || "Ustadz"}
          </span>
          <Avatar>
            <AvatarImage
              src={profile?.avatar_url || "/placeholder.svg"}
              alt={profile?.full_name || "Ustadz"}
            />
            <AvatarFallback>
  ...
  return (
    <Card className="flex-1">
      <CardHeader className="pb-2">
        ...
        <CardDescription>
          {profile?.role === "ustadz" ? "Pengajar" : "Ustadz"}
        </CardDescription>
      </CardHeader>
      <CardContent>
...
async function MyCourses() {
  ...
  if (error) {
    return (
      <p className="text-red-500 col-span-full">Gagal memuat kursus: {error}</p>
    );
  }
  ...
  if (!courses || courses.length === 0) {
    return (
      <p className="text-gray-500 col-span-full">
        ...
        <Link
          href="/dashboard/ustadz/courses/new"
    ...
    <>
      ...
      <Card className="flex flex-col items-center justify-center p-6 border-dashed border-2">
        ...
        <p className="text-sm text-gray-500 text-center mb-4">
          Buat kursus baru untuk santri Anda
        </p>
        <Link href="/dashboard/ustadz/courses/new">
          <Button className="bg-green-700 hover:bg-green-800">
            Tambah Kursus
